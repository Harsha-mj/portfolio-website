      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            variants={fadeInUp}
          >
            <img src="public/Harsha_bio.JPG" alt="Harshavardhan" className="w-full h-full object-cover rounded-2xl" />
          ...
          <motion.div className="md:col-span-2 flex flex-col justify-between space-y-6" variants={staggerContainer}>
            <motion.p className="text-lg text-gray-700" variants={fadeInUp}>
              Hello there, my name is Harshavardhan. I am a Data Scientist based in Ottawa, Canada.<br/><br/>
              <strong>Fun fact</strong> - I was born on 04/11 (April 11) at 10:00 pm<br/><br/>
