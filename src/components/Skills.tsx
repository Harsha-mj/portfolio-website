...
const skills = [
  {
    ...
    skills: [
      ...
      'Deep Learning: CNN, LSTM, Tensorflow, Pytorch','Time Series Forecasting: ARIMA',
      ...
      'MLOps','Langchain', 'Huggingface'
    ],
    tools:['Tableau', 'PowerBI', ' Alteryx', 'Azure ML', 'AWS Sagemaker']
  },
  {
    category: 'Supply chain Management',
    icon: History,
    skills: ['Inventory Control', 'Procurement', 'Logistics Coordination', 'Demand Forecasting', 'Warehouse Management', 'Supplier Relationship Management'],
    tools: ['SAP', 'Oracle SCM', 'Excel', 'Power BI', 'Tableau']
  },
  {
    category: 'Database',
    icon: Database,
    skills: ['MongoDB', 'Oracle', 'BigQuery'],
    tools: ['MongoDB Compass, Oracle SQL Developer'],
  },
  {
    category: 'Programming Languages',
    icon: Code,
    skills: ['Python', 'SQL'],
    tools: ['Visual Studio Code, Jupyter Notebook, Oracle SQL Developer'],
  },
];
